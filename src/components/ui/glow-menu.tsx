  ...
  ({ className, items, activeItem, onItemClick }, ref) => {
    ...
    return (
      <motion.nav
        ref={ref}
        className={cn(
          "p-2 rounded-2xl bg-gradient-to-b from-white/80 to-white/40 dark:from-background/80 dark:to-background/40 backdrop-blur-lg border border-gray-200 dark:border-border/40 shadow-lg relative overflow-hidden",
          className,
        )}
        initial="initial"
        whileHover="hover"
                    ...
                    <motion.div
                      className={cn(
                        ...
                        isActive
                          ...
                          : "text-gray-600 dark:text-muted-foreground group-hover:text-black dark:group-hover:text-foreground",
                      )}
